...
namespace WebVisit.Migrations.SVISIT
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsertOrgID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateOrgID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalOrgID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactOrgID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgNameKor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    OrgNameEng = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MealGB1 = table.Column<int>(type: "int", nullable: false),
                    MealGB2 = table.Column<int>(type: "int", nullable: false),
                    MealGB3 = table.Column<int>(type: "int", nullable: false),
                    MealGB4 = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SafetyViolationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ViolationDate = table.Column<string>(type: "char(10)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "Buchen", "부천", 1, null, null, null, null, "1", "Y", "Y", null, 2, "2000", 1, null },
                    { 4, "Sangwoo", "상우", 1, null, null, null, null, "1", "Y", "Y", null, 3, "3000", 2, null },
                    { 5, "GlobalChip", "글로벌칩스", 1, null, null, null, null, "1", "Y", "Y", null, 4, "6000", 3, null },
                    ...
                    { 27, "Passenger Car", "승용", 26, null, null, null, null, "1", "Y", "N", null, 1, null, 0, null },
                    { 28, "Business Car", "영업", 26, null, null, null, null, "1", "Y", "N", null, 2, null, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 43, "", "납품", 39, null, null, null, null, "1", "N", "Y", "N", null, 4, null, 3, null },
                    { 44, "Etc", "기타", 39, null, null, null, null, "1", "Y", "Y", "N", null, 5, null, 4, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 87, "Common Clean Room", "공통-통제구역-적색-클린룸", 86, null, null, null, null, "1", "Y", "Y", null, 1, null, 0, null },
                    { 88, "Inside Building", "공통-제한구역-황색-건물내부", 86, null, null, null, null, "1", "Y", "Y", null, 2, null, 1, null },
                    { 89, "Exterior Building", "공통-일반구역-청색-건물외부/접견실/납품", 86, null, null, null, null, "1", "Y", "Y", null, 3, null, 2, null },
                    { 90, "Day Care Center", "부천-일반구역-청색-햇살어린이집", 86, null, null, null, null, "1", "Y", "Y", null, 4, null, 3, null },
                    { 91, "VIP", "공통-특별구역-VIP", 86, null, null, null, null, "1", "Y", "Y", null, 5, null, 4, null },
                    { 92, "Government", "부천-특별구역-공무", 86, null, null, null, null, "1", "Y", "Y", null, 6, null, 5, null },
                    { 93, "↓↓Accident Preparedness Material Handling Facility↓↓", "↓↓사고대비물질 취급시설↓↓", 86, null, null, null, null, "1", "Y", "Y", null, 7, null, 6, null },
                    { 94, "Chemical Storage Warehouse", "공통-제한구역-황색-가스케미칼보관창고", 86, null, null, null, null, "1", "Y", "Y", null, 8, null, 7, null },
                    { 95, "Chemical Analysis Room", "공통-제한구역-황색-화학분석실", 86, null, null, null, null, "1", "Y", "Y", null, 9, null, 8, null },
                    { 96, "Defect Analysis Office", "공통-제한구역-황색-불량분석실", 86, null, null, null, null, "1", "Y", "Y", null, 10, null, 9, null },
                    { 97, "CCSS", "공통-제한구역-황색-CCSS", 86, null, null, null, null, "1", "Y", "Y", null, 11, null, 10, null },
                    { 98, "MBR", "부천-제한구역-황색-MBR", 86, null, null, null, null, "1", "Y", "Y", null, 12, null, 11, null },
                    { 99, "WWT", "상우-제한구역-황색-WWT", 86, null, null, null, null, "1", "Y", "Y", null, 13, null, 12, null },
                    { 100, "Sulfuric Acid Tank", "부천-제한구역-황색-황산탱크(옥상)", 86, null, null, null, null, "1", "Y", "Y", null, 14, null, 13, null },
                    { 101, "Organic Recovery Room", "상우-제한구역-황색-유기회수실", 86, null, null, null, null, "1", "Y", "Y", null, 15, null, 14, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 125, "Not issued", "미발급", 124, null, null, null, null, "1", "Y", "Y", null, 1, null, 0, null },
                    { 126, "Issuance", "발급", 124, null, null, null, null, "1", "Y", "Y", null, 2, null, 1, null },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 178, "Waiting Approval", "승인대기", 177, null, null, null, null, "1", "Y", "Y", null, 1, null, 0, null },
                    { 179, "Approved", "승인완료", 177, null, null, null, null, "1", "Y", "Y", null, 2, null, 1, null },
                    ...
                    { 224, "PreOrder", "선입고", 39, null, null, null, null, "1", "Y", "N", null, 6, null, 5, null },
                    ...
                    { 253, "Dormancy", "휴면", 124, null, null, null, null, "1", "Y", "N", null, 4, null, 3, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "MealPrice",
                columns: new[] { "MealPriceID", "InsertName", "InsertOrgID", "InsertOrgNameEng", "InsertOrgNameKor", "InsertSabun", "Location", "Price", "UpdateDate", "UpdateIP" },
                values: new object[,]
                {
                    { 1, null, null, null, null, "1", "2000", 3500, null, null },
                    { 2, null, null, null, null, "1", "3000", 3500, null, null },
                    { 3, null, null, null, null, "1", "6000", 4000, null, null }
                });

            migrationBuilder.InsertData(
                table: "MealSchedule",
                columns: new[] { "MealScheduleID", "EndTime", "InsertName", "InsertOrgID", "InsertOrgNameEng", "InsertOrgNameKor", "InsertSabun", "MealGB", "StartTime", "Term", "UpdateDate", "UpdateIP" },
                values: new object[,]
                {
                    { 1, "0900", null, null, null, null, "1", 1, "0530", 0, null, "" },
                    { 2, "1400", null, null, null, null, "1", 2, "1130", 0, null, "" },
                    { 3, "1900", null, null, null, null, "1", 3, "1630", 0, null, "" },
                    { 4, "2330", null, null, null, null, "1", 4, "2130", 0, null, "" },
                    { 5, "0900", null, null, null, null, "1", 1, "0530", 1, null, "" },
                    { 6, "1400", null, null, null, null, "1", 2, "1130", 1, null, "" },
                    { 7, "1900", null, null, null, null, "1", 3, "1630", 1, null, "" },
                    { 8, "2330", null, null, null, null, "1", 4, "2130", 1, null, "" }
                });

            migrationBuilder.InsertData(
                table: "MealTerm",
                columns: new[] { "MealTermID", "EndDate", "InsertName", "InsertOrgID", "InsertOrgNameEng", "InsertOrgNameKor", "InsertSabun", "StartDate", "Term", "UpdateDate", "UpdateIP" },
                values: new object[,]
                {
                    { 1, "0831", null, null, null, null, "1", "0401", 0, null, "" },
                    { 2, "0331", null, null, null, null, "1", "0901", 1, null, "" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 44, 0, 44, "/images/ico/ico-gnb-list12.svg", null, null, null, null, "1", "Card Apply", "출입증발급관리", 1, "", null },
                    { 45, 1, 44, null, null, null, null, null, "1", "Card Apply Person", "인원출입증신청현황", 2, "/card/applylist", null },
                    { 46, 1, 44, null, null, null, null, null, "1", "Card Apply Car", "차량출입증승인현황", 5, "/card/carapplylist", null },
