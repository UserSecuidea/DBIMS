...
[Keyless]
[Table("MTS_MMS_MSG_LOG")]
[Index("TranPr", Name = "idx1_MTS_MMS_MSG_LOG")]
[Index("TranPhone", Name = "idx2_MTS_MMS_MSG_LOG")]
[Index("TranDate", Name = "idx3_MTS_MMS_MSG_LOG")]
[Index("TranStatus", Name = "idx4_MTS_MMS_MSG_LOG")]
[Index("TranRefkey", Name = "idx5_MTS_MMS_MSG_LOG")]
public partial class MtsMmsMsgLog
{
    [Column("TRAN_PR")]
    ...
    [StringLength(15)]
    [Unicode(false)]
    public string? TranCallback { get; set; }
