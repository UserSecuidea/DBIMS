...
{
    public class CarCardIssueApplyHistory
    {
        /* 
        req: CarCardIssueApplyHistoryID, CarCardIssueApplyID, Sabun, TermsPrivarcyFile, ContactSabun, CardTypeID, CardIssueType, CarNo, CarTypeCodeID, CardApplyStatus
        no req: OrgID, OrgNameKor, OrgNameEng, ContactOrgID, ContactOrgNameKor, ContactOrgNameEng, CardID, CardNo, ReissueNo, ApplyReason, CarLIcenseFile, Memo
        ...
        */
        [Key]
        public int CarCardIssueApplyHistoryID { get; set; }
        ...
        public CarCardIssueApplyHistory(){
            //
        }
