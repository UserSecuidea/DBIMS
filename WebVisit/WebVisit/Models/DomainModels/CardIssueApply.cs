...
{
    public class CardIssueApply
    {
        /* 
        req: CardIssueApplyID, Sabun, TermsPrivarcyFile, ContactSabun, CardTypeID, CardIssueType, CardApplyStatus
        no req: OrgID, OrgNameKor, OrgNameEng, ContactOrgID, ContactOrgNameKor, ContactOrgNameEng, CardID, CardNo, ReissueNo, ApplyReason,
        ...
        */
        ...
        public CardIssueApply(){
            //
        }
        
        public CardIssueApply Clone() => (CardIssueApply)MemberwiseClone();
