...
[Table("AlarmProcess_202302")]
public partial class AlarmProcess202302
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202302s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202302EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202302Updates")]
