...
[Table("AlarmProcess_202303")]
public partial class AlarmProcess202303
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202303s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202303EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202303Updates")]
