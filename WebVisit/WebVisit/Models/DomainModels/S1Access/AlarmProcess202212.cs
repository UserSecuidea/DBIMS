...
[Table("AlarmProcess_202212")]
public partial class AlarmProcess202212
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202212s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202212EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202212Updates")]
