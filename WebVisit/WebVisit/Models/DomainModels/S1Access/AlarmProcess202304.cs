...
[Table("AlarmProcess_202304")]
public partial class AlarmProcess202304
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202304s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202304EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202304Updates")]
