...
[Table("AlarmProcess_202306")]
public partial class AlarmProcess202306
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202306s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202306EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202306Updates")]
