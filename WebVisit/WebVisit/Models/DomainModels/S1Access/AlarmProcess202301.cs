...
[Table("AlarmProcess_202301")]
public partial class AlarmProcess202301
{
    [Key]
    ...
    [InverseProperty("AlarmProcess202301s")]
    public virtual AlarmReasonType AlarmReasonType { get; set; } = null!;

    [ForeignKey("EqUserId")]
    [InverseProperty("AlarmProcess202301EqUsers")]
    public virtual EqUser EqUser { get; set; } = null!;

    [ForeignKey("UpdateId")]
    [InverseProperty("AlarmProcess202301Updates")]
