...
{
    public class CarCardIssueApplyGridData:GridData
    {
        ...
        public int SearchCarTypeCodeID { get; set; } = -1;
        ...
        public CarCardIssueApplyGridData()
        {
        ...
        public override Dictionary<string, string> ToDictionary()  =>
            new Dictionary<string, string> {
                ...
                { nameof(SearchCarTypeCodeID), SearchCarTypeCodeID.ToString() },
