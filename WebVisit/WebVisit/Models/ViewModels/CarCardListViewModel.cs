...
{
    public class CarCardListViewModel
    {
        public IEnumerable<CarCardIssueApply> CarCardIssueApplys { get; set; } = new List<CarCardIssueApply>();
        public IEnumerable<Company> Companies { get; set; } = new List<Company>();
        public CarCardGridData CurrentRoute { get; set; } = new CarCardGridData();
        public CarCardGridData SearchRoute { get; set; } = new CarCardGridData();
