...
namespace WebVisit.Models
{
    public class CardListViewModel
    {
        ...
        public IEnumerable<ViewCardPerson> ViewCardPeople { get; set; } = new List<ViewCardPerson>();

        public IEnumerable<Company> Companies { get; set; } = new List<Company>();
        public CardGridData CurrentRoute { get; set; } = new CardGridData();
        public CardGridData SearchRoute { get; set; } = new CardGridData();
