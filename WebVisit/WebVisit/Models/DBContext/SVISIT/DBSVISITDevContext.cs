...
{
    public class DBSVISITDevContext : BaseSVISITContext {
        public DBSVISITDevContext(DbContextOptions<DBSVISITDevContext> options): base(options) {
            Console.WriteLine("init DBSVISITDevContext");
        }
        /*
