...
{
    public class SVISITContext : BaseSVISITContext {
        public SVISITContext(DbContextOptions<SVISITContext> options): base(options) {
            Console.WriteLine("init SVISITContext");
        }
        /*
