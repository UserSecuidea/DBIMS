...
{
    public class DBSVISITContext  : BaseSVISITContext {
        public DBSVISITContext(DbContextOptions<DBSVISITContext> options): base(options) {
            Console.WriteLine("init DBSVISITContext");
        }
        /*
